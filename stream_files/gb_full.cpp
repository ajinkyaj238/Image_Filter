...
/*
Creates the window to be sent for computation for each pixel
*/
...
//    int new_image[SIZE_LEN];
    ...
    for(int pix = 0; pix < (SIZE_LEN); pix++)
    {
        ...
        new_image[pix] = window[0];
    }



    // returns the value back to image array for easy axi streaming
